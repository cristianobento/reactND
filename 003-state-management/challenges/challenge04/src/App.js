  ...
  render() {
    return (
      <div className="App">
        ...
        <div className="game">
          <h2>Mental Math</h2>
          { /* componente Game com state sendo um callback de função para uso dentro do mesmo */}
          <Game handleAnswer={this.handleAnswer} />
          {/* componente Score enviando número de opções corretas e o número total de opções */}
